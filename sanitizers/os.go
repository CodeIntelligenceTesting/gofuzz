...
func OsChmod(hookId int, name string, mode os.FileMode) error {
	detectors.PTDect.New(hookId, name, nil, nil).Detect()
...
func OsLink(hookId int, oldname, newname string) error {
	detectors.PTDect.New(hookId, oldname, nil, nil).Detect()
	detectors.PTDect.New(hookId*31, newname, nil, nil).Detect()
...
func OsRename(hookId int, oldpath, newpath string) error {
	detectors.PTDect.New(hookId, oldpath, nil, nil).Detect()
	detectors.PTDect.New(hookId*31, newpath, nil, nil).Detect()
...
func OsRemoveAll(hookId int, path string) error {
	detectors.PTDect.New(hookId, path, nil, nil).Detect()
